...
model_ATP = readCbModel('Models/MethanotrophT1ATP.mat');
...
mIATPOUT(1:rxnno,i) = FBAflux ; %fluxes output
mIATPOUT(rxnno+1,i) = maxYield_ATP_methane;
mIATPOUT(rxnno+2,i) = O2toMethane;
mIATPOUT(rxnno+3,i) = CO2Yield;  
mIATPOUT(rxnno+4,i) = GWP100Yield;  
mIATPOUT(rxnno+5,i) = acetateYield; 
mIATPOUT(rxnno+6,i) = acetoneYield; 
mIATPOUT(rxnno+7,i) = ethanolYield;  
mIATPOUT(rxnno+8,i) = formaldehydeYield;
mIATPOUT(rxnno+9,i) = formateYield;  
mIATPOUT(rxnno+10,i) = lactateYield;  
mIATPOUT(rxnno+11,i) = methanolYield;  
mIATPOUT(rxnno+12,i) = pyruvateYield;  
mIATPOUT(rxnno+13,i) = succinateYield;
mIATPOUT(rxnno+14,i) = fermentsYield;
%mIATPOUT(rxnno+15,i) = PHBYield;  % Type I do not make PHB
...
xlswrite(["260113_mI_ATP_sMMO_N2.xlsx"],mIATPOUT);   
